...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 09:47 PM
...
(1, 'WhatsApp Image 2022-01-12 at 11.58.58 PM.jpeg', 'image/jpeg');
...
(1, 'Demo Product', '48', '100.00', '500.00', 1, 1, '2021-04-04 16:45:51'),
...
(1, 1, 15, '100.00000', '2022-01-17'),
(4, 2, 120, '55.00000', '2022-01-15');
...
(1, 'Harry Denn', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'no_image.png', 1, '2022-01-16 18:59:38'),
...
--
ALTER TABLE `purchase`
  ADD CONSTRAINT `PK` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
